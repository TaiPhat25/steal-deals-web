  ...
  const users = [
    {
      ...
      role: "Seller",
      roleClass: "bg-warning-alpha-16 text-warning-dark",
      lastAccess: "11 Sept, 2027",
      status: "Suspended",
    ...
    },
    {
      ...
      role: "Buyer",
      roleClass: "bg-success-alpha-16 text-success-dark",
      lastAccess: "12 Sept, 2027",
      status: "Active",
    ...
    },
    {
      ...
      role: "Admin",
      roleClass: "bg-error-alpha-16 text-error-dark",
      lastAccess: "14 Sept, 2027",
      status: "Active",
      statusClass: "bg-primary-alpha-16 text-primary-dark",
    },
    {
    ...
    },
    {
      ...
      name: "Frank Garcia",
      avatar: "/admin/images/user/manface.avif",
      email: "frank5@gmail.com",
      role: "Admin",
      roleClass: "bg-error-alpha-16 text-error-dark",
      lastAccess: "16 Sept, 2027",
      status: "Suspended",
      statusClass: "bg-error-alpha-16 text-error-dark",
    },
    {
      ...
      name: "Grace Miller",
      avatar: "/admin/images/user/womanface.avif",
      email: "grace6@gmail.com",
      role: "Admin",
      roleClass: "bg-error-alpha-16 text-error-dark",
      lastAccess: "17 Sept, 2027",
      status: "Active",
      statusClass: "bg-primary-alpha-16 text-primary-dark",
    },
    {
      ...
      name: "Heidi Davis",
      avatar: "/admin/images/user/womanface.avif",
      email: "heidi7@gmail.com",
      role: "Buyer",
      roleClass: "bg-success-alpha-16 text-success-dark",
      lastAccess: "18 Sept, 2027",
      status: "Active",
      statusClass: "bg-primary-alpha-16 text-primary-dark",
    },
    {
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <div className="min-w-[140px]">
                <button
                  ...
                  type="button"
                >
                  <span className="block truncate text-light-secondary-text">Role</span>
              ...
              <div className="min-w-[140px]">
                <button
                  ...
                  type="button"
                >
                  <span className="block truncate text-light-secondary-text">Account status</span>
                  <span className="pointer-events-none flex items-center pl-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" className="h-5 w-5">
                      <path
                        fill="currentColor"
              ...
              <tbody className="[&_tr:last-child]:border-0">
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-3.5 first:pl-5 last:pr-5 align-middle font-normal whitespace-nowrap text-sm text-light-primary-text">
                      {user.id}
                    </td>
                    <td className="px-3 py-3.5 first:pl-5 last:pr-5 align-middle whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-light-primary-text">{user.name}</span>
                      </div>
                    </td>
                    <td className="px-3 py-3.5 first:pl-5 last:pr-5 align-middle text-sm whitespace-nowrap text-light-primary-text">
                      {user.email}
                    </td>
                    <td className="px-3 py-3.5 first:pl-5 last:pr-5 align-middle whitespace-nowrap">
                      <div className="flex items-center gap-1.5">
                        <span className={`px-2 py-1 h-5.5 inline-flex items-center justify-center font-public-sans rounded-full text-xs font-medium ${user.roleClass}`}>
                          {user.role}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-3 py-3.5 first:pl-5 last:pr-5 align-middle whitespace-nowrap">
                      <span className={`px-2 py-1 h-5.5 inline-flex items-center justify-center font-public-sans rounded-full text-xs font-medium ${user.statusClass}`}>
                        {user.status}
                      </span>
                    </td>
