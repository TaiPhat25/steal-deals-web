...
export default function AdminInbox() {
  ...
  const contacts = [
    {
      id: 1,
      name: "Xian Zhou",
      avatar: "/admin/images/user/user_017e4b.png",
      time: "4:05 PM",
    ...
    },
    {
      id: 2,
      name: "Sarah Smith",
      avatar: "/admin/images/user/user_0297fd.png",
      time: "5 mins",
    ...
    },
    {
      id: 3,
      name: "Michael Chen",
      avatar: "/admin/images/user/user_03e63e.png",
      time: "1 hour",
    ...
    },
    {
      id: 4,
      name: "Emily Davis",
      avatar: "/admin/images/user/user_04d398.png",
      time: "2 hours",
    ...
    },
    {
      id: 5,
      name: "David Wilson",
      avatar: "/admin/images/user/user_051ee2.png",
      time: "1 day",
  ...
  return (
    <AdminLayout>
      <div className="h-[calc(100vh-140px)] min-h-[600px] bg-white rounded-2xl overflow-hidden flex w-full">
          ...
          <div className="flex flex-col h-full pb-4">
            <div className="px-6 pt-6 pb-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="outline-none size-8 rounded-full flex items-center justify-center hover:bg-gray-200 text-light-primary-text">
            ...
            <div className="flex-1 overflow-y-auto px-1">
              {contacts.map((contact) => (
                ...
                >
                  <div className="relative flex overflow-hidden rounded-full items-center justify-center w-10 h-10 shrink-0 font-medium text-gray-600 bg-gray-200">
                    <img alt={contact.name} className="aspect-square h-full w-full object-cover" src={contact.avatar} />
                  </div>
          ...
          <div className="flex flex-col h-full bg-white">
            ...
            <div className="flex items-center justify-between py-4 px-5 lg:px-6 border-b border-gray-500/20">
              <div className="flex items-center gap-4">
                <div className="relative flex shrink-0 overflow-hidden items-center justify-center font-medium text-gray-600 text-sm rounded-lg w-12 h-12">
                  <img alt={activeContact.name} className="aspect-square h-full w-full object-cover" src={activeContact.avatar} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <button className="rounded-full inline-flex items-center justify-center cursor-pointer font-bold transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 h-8 w-8 p-0 text-light-primary-text">
                ...
                <button className="outline-none rounded-full inline-flex items-center justify-center cursor-pointer font-bold transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 h-8 w-8 p-0 text-light-primary-text">
              ...
              {activeContact.messages.map((message) => (
                ...
                >
                  <div className="flex items-end gap-2">
                    {message.sender !== "me" && (
                      <div className="relative flex overflow-hidden rounded-full items-center justify-center font-medium text-gray-600 w-8 h-8 text-xs bg-gray-200 shrink-0">
                        <img alt="Avatar" className="aspect-square h-full w-full object-cover" src={activeContact.avatar} />
                      </div>
                    )}
                    <div>
                      <div
            ...
            <div className="p-6">
              <div className="bg-gray-50 h-18 border border-gray-500/20 rounded-xl px-6 py-4 flex items-center gap-2">
                ...
                <div className="flex items-center">
                  <button className="inline-flex items-center justify-center cursor-pointer font-bold transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed rounded-lg hover:bg-gray-100 hover:text-gray-900 border-none shadow-none bg-transparent p-0 text-light-primary-text w-10 h-10">
