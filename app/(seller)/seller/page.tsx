  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">{metrics.map(([label, value, color]) => <DashboardCard key={label} className={`${color} p-4`}><p className="text-sm font-semibold text-light-secondary-text">{label}</p><p className="mt-2 text-2xl font-bold">{value}</p></DashboardCard>)}</div>
