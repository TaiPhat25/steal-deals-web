    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <DashboardCard className="grid gap-6 p-4 sm:p-6 lg:grid-cols-[280px_1fr]">
          <div className="overflow-hidden rounded-2xl bg-gray-100"><ProductImage alt={product.name} src={product.imageUrl} /></div>
          <div>
            ...
            <p className="mt-4 text-xs text-light-secondary-text">{product.imageUrl ? "Bag image configured." : "Using the bag placeholder image."}</p>
          </div>
        </DashboardCard>
      </div>
    </>
