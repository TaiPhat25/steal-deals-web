        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-light-primary-text">Create Product</h2>
            </div>
            <div className="w-28">
              <button
                className="relative h-7.5 flex items-center justify-between w-full cursor-pointer rounded-full border border-primary text-[13px] font-bold bg-[rgba(0,171,85,0.08)] px-4 py-2 text-left focus:outline-none transition-colors"
                type="button"
              >
                <span className="block truncate font-bold text-primary-dark mr-1.5">Publish</span>
                <span className="pointer-events-none flex items-center">
                  <svg className="h-5 w-5 text-primary-dark" fill="none" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path
                      clipRule="evenodd"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="relative">
                <input
                  ...
                  type="text"
                />
                <label className="absolute text-sm text-primary duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-left left-3.5 bg-white peer-placeholder-shown:bg-transparent peer-focus:bg-white px-1 peer-focus:px-1 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:text-light-disabled-text peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 cursor-text">
                  Product Name
                </label>
              </div>
              <div className="relative">
            ...
            <div className="mt-4 sm:mt-6">
              <div className="relative">
                <textarea
                  ...
                  placeholder=" "
                />
                <label className="absolute text-sm text-primary duration-300 transform -translate-y-4 scale-75 top-2 z-10 left-3.5 origin-left bg-white peer-placeholder-shown:bg-transparent peer-focus:bg-white px-1 peer-focus:px-2 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:text-light-disabled-text peer-placeholder-shown:translate-y-3 peer-placeholder-shown:top-1 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 cursor-text">
                  Short Description
                </label>
              </div>
            </div>
          ...
          {/* Media */}
          <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-500/20">
            <h2 className="text-lg font-bold text-gray-900 mb-4 sm:mb-6">Media</h2>
              ...
              <div className="w-full">
                <div className="group relative flex h-full min-h-[200px] cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-gray-500/30 bg-white p-6 text-center hover:bg-gray-50">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-light-secondary-text">Upload Product photo</p>
                      <p className="text-xs text-light-secondary-text">Allowed *.jpeg, *.jpg, *.png, *.gif</p>
                    </div>
                  </div>
                </div>
          ...
          {/* Pricing & Discount */}
          <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-500/20">
            <h2 className="text-lg font-bold text-gray-900 mb-4 sm:mb-6">Pricing & Discounts</h2>
