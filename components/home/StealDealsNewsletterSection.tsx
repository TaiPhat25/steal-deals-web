...
export default function StealDealsNewsletterSection() {
  return (
    <section className="container" aria-labelledby="newsletter-title">
      <div className="newsletter-section bg-image d-flex align-items-center justify-content-center mb-1 pt-2 pb-2 px-3" style={{ backgroundImage: "url(/assets/images/demos/demo-28/banners/4.jpg)" }}>
