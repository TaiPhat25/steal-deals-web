...
export default function SellerHeader({ onToggleSidebar }: HeaderProps) {
            ...
            <div className="absolute right-0 mt-2 w-40 bg-white border border-gray-100 rounded-md shadow-lg py-1 z-50">
              ...
              >
                <span className="w-5 h-5 relative block">
                  <img src="/seller/images/flag/GB.svg" alt="English" className="object-cover w-full h-full" />
                </span>
                English
              </button>
            </div>
        ...
        <div className="text-right relative">
          ...
          >
            <span className="h-8 w-8 relative rounded-full overflow-hidden block">
              <img
                ...
                src="/seller/images/user/manface.avif"
              />
            </span>
          ...
          {showProfile && (
            <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-md shadow-lg py-1 z-50">
              ...
              <Link href="/seller/settings" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 w-full text-left">
                Store Profile
              </Link>
