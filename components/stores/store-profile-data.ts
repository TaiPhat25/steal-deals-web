...
export const storeProfiles: StoreProfile[] = [
  ...
  },
  {
    ...
    surpriseBags: [
      ...
      {
        id: "137b2d0d-0c73-4fe2-9e23-100000000007",
        storeId: greenBasketId,
        name: "Vegetable Harvest Surprise Bag",
        description: "A seasonal mix of vegetables packed from daily surplus.",
  ...
  },
  {
    ...
    surpriseBags: [
      ...
      {
        id: "137b2d0d-0c73-4fe2-9e23-100000000008",
        storeId: harborFreshId,
        name: "Seafood Weekend Surprise Bag",
        description: "A weekend seafood box selected from the store's surplus.",
        ...
        expiryDate: "2026-08-05T22:00:00+07:00",
        status: "Active",
